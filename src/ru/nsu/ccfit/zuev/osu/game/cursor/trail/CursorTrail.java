...
public class CursorTrail extends ParticleSystem {
    public CursorTrail(
        ...
        addParticleModifier(new ExpireModifier(0.1475f * GameHelper.getSpeedMultiplier()));
        addParticleModifier(new AlphaModifier(GameHelper.getSpeedMultiplier(), 0.0f, 0f, 0.1475f));
