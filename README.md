...
Currently, the game has a bunch of bugs, which might be replicable in-game. There are also experiments, which are no longer visible in this GitHub repository.

## Features
This custom build features a custom performance points (pp) system, known as droid relax points (drp), which only affects with the relax mod applied, alongside the experimental settings that would likely not work, further game optimization, and smaller playfield areas, *that could just make it playable like a tablet, so bring a stylus with you*.
...
## Status
osudroid!relax is currently in development, it's source code is up to date with the osu!droid github repository (July 23, 2024)
...
## Download
**!! THERE ARE NO RELEASES AT THIS POINT SINCE I MESSED UP AND ENDED UP DELETING THE OLD REPOSITORY !!**

For beta builds, you must log in or create a GitHub account in order to access and download it. While for release builds, it's free although, you can access the [releases page](https://github.com/LouieNotHere/osudroid-rx/releases) and look for the archive.

To install the app, extract the archive and install it, simple.

## Contributing
The build is open-source! Which means you can fork or clone it, and commit stuff on the go!
...
osudroid!relax is licensed under the [Apache License 2.0](https://opensource.org/licenses/Apache-2.0) license, you can check and view it.
